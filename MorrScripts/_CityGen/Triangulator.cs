...
public class Triangulator
{
    ...
    public static Mesh CreateMesh(Vector2[] poly, float extrusionAmount = 1f)
    {
        ...
        for (int i = 0; i < poly.Length; i++)
        {
            ...
            vertices[i].z = -extrusionAmount;//-10; // front vertex
            vertices[i + poly.Length].x = poly[i].x;
            vertices[i + poly.Length].y = poly[i].y;
            vertices[i + poly.Length].z = extrusionAmount; //10;  // back vertex    
        }
